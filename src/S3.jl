...
type RO # RequestOptions
  ...
  istream::Any
  ostream::Any
  conn::Union(Nothing, ConnContext)
  max_buff_size::Int64

  RO() = new(:GET, "", "", {}, {}, {}, "", "", nothing, nothing, nothing, -1,)
  RO(verb, bkt, key) = new(verb, bkt, key, {}, {}, {}, "", "", nothing, nothing, nothing, -1)
end
export RO
...
function do_http(env::AWSEnv, ro::RO)
  ...
  url = "http://s3.amazonaws.com" * full_path
...
function canonicalize_and_sign(env::AWSEnv, ro::RO, md5::String)
  ...
  # when we open an object, authenticate for "get" requests
